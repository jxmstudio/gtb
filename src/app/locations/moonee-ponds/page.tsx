...
export const metadata: Metadata = {
  ...
  description: "TOFA Group builds custom homes, knockdown rebuilds, and renovations in Moonee Ponds, VIC. Quality construction — fixed price, fully insured. Free consultation.",
