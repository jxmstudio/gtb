...
export const featuredProjects: ProjectShowcaseItem[] = [
  ...
  },
  {
    ...
    name: 'TOFA Showroom · 268 Mt Alexander Rd',
    suburb: 'Ascot Vale, VIC',
  ...
  {
    slug: 'glen-waverley',
    name: '3 Bridget Street',
    suburb: 'Glen Waverley, VIC',
